...
function QrCodeComponent() {
  return (
     <div id='qr' className="relative flex justfiy-center items-center h-[450px] w-[300px]  rounded-xl shadow-2xl sm:w-[350px] md:h-[260px] md:w-[260px] mt-16">
                  ...
                  <div className="absolute z-40 -top-12 -left-5 w-16 h-16">
